...
public class ItemSignToolCut extends AItemSignTool
{
	public ItemSignToolCut(String modId)
	{
		super(modId, "tool.sign.cut");
	}
	...
	@Override public SignToolType getSignToolType(ItemStack stack) { return SignToolType.Cut; }
	...
	@Override public boolean onSignActivated(TileEntitySign sign, ItemStack stack, EntityPlayer player)
	{
		if (!player.worldObj.isRemote)
		{
			...
			addChatMessage(player, "item.tool.sign.cut.state." + state + ".result." + result + ".text");
		}
		return true;
	}
